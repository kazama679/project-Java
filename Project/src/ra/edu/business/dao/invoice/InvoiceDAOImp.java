...
public class InvoiceDAOImp implements InvoiceDAO{
    ...
    public double totalDay(LocalDate dateStart, LocalDate dateEnd) {
        ...
        try {
            ...
            System.err.println("Có lỗi trong quá trình tính tổng doanh thu theo ngày trong InvoiceDAOImp: " + e.getMessage());
        } catch (Exception e) {
            System.err.println("Có lỗi không xác định trong InvoiceDAOImp: " + e.getMessage());
        } finally {
            ConnectionDB.closeConnection(conn, callSt);
        }
        return total;
    ...
    public double totalMonth(int monthStart, int yearStart, int monthEnd, int yearEnd) {
        ...
        try {
            ...
            System.err.println("Có lỗi trong quá trình tính tổng doanh thu theo tháng trong InvoiceDAOImp: " + e.getMessage());
        } catch (Exception e) {
            System.err.println("Có lỗi không xác định trong InvoiceDAOImp: " + e.getMessage());
        } finally {
            ConnectionDB.closeConnection(conn, callSt);
    ...
    public double totalYear(int yearStart, int yearEnd) {
        ...
        try {
            ...
            System.err.println("Có lỗi trong quá trình tính tổng doanh thu theo năm trong InvoiceDAOImp: " + e.getMessage());
        } catch (Exception e) {
            System.err.println("Có lỗi không xác định trong InvoiceDAOImp: " + e.getMessage());
        } finally {
            ConnectionDB.closeConnection(conn, callSt);
